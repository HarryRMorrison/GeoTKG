...
from training.models.globals import EVENT_BI, TIMEX_BI, LABEL2ID_EVNER, LABEL2ID_EE, ID2LABEL_EVNER, ID2LABEL_EE
...
class TIEModel(nn.Module):
    ...
    def predict(self, text_batch):
        ...
        ee_pairs = torch.nn.utils.rnn.pad_sequence(ee_pairs, batch_first=True, padding_value=0)
        ee_mask = torch.nn.utils.rnn.pad_sequence(ee_mask, batch_first=True, padding_value=False)
